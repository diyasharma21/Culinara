    ...
    <div className="min-h-screen bg-stone-50 pt-14 pb-16 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          <Link
            href={backLink}
            className="inline-flex items-center gap-2 text-stone-600 hover:text-[#4edb71] transition-colors mb-4"
          >
        ...
        {loading && (
          <div className="flex flex-col justify-center items-center py-20">
            <Loader2 className="w-10 h-10 text-[#2f8143] animate-spin mb-4" />
            <p className="text-stone-500">Fetching the Recipes...</p>
          </div>
        )}
        ...
        {!loading && meals.length === 0 && (
          <div className="text-center py-20">
            ...
            <Link href={backLink}>
              <span className="inline-flex items-center gap-2 text-[#2f8143] hover:text-[#4edb71] font-semibold">
                <ArrowLeft className="w-4 h-4" />
